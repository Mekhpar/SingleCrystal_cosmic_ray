...
//=========  (Wed Mar 20 14:25:58 2024) by ROOT version 6.26/08
   TCanvas *c = new TCanvas("c", "c",216,216,800,800);
   c->Range(0,0,1,1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
...
// ------------>Primitives in pad: toppad
   ...
   entry->SetTextSize(0.04);
   leg->Draw();
   TLatex *   tex = new TLatex(0.17,0.83,"Ch 1");
tex->SetNDC();
   tex->SetTextFont(52);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   Plot_comp__1->SetBinContent(2,38);
   Plot_comp__1->SetBinContent(3,53);
   Plot_comp__1->SetBinContent(4,41);
   Plot_comp__1->SetBinContent(5,31);
   Plot_comp__1->SetBinContent(6,26);
   Plot_comp__1->SetBinContent(7,25);
   Plot_comp__1->SetBinContent(8,24);
   Plot_comp__1->SetBinContent(9,22);
   Plot_comp__1->SetBinContent(10,16);
   Plot_comp__1->SetBinContent(11,13);
   Plot_comp__1->SetBinContent(12,11);
   Plot_comp__1->SetBinContent(13,15);
   Plot_comp__1->SetBinContent(14,16);
   Plot_comp__1->SetBinContent(15,17);
   Plot_comp__1->SetBinContent(16,24);
   Plot_comp__1->SetBinContent(17,31);
   Plot_comp__1->SetBinContent(18,27);
   Plot_comp__1->SetBinContent(19,28);
   Plot_comp__1->SetBinError(1,28);
   Plot_comp__1->SetBinError(2,38);
   Plot_comp__1->SetBinError(3,53);
   Plot_comp__1->SetBinError(4,41);
   Plot_comp__1->SetBinError(5,31);
   Plot_comp__1->SetBinError(6,26);
   Plot_comp__1->SetBinError(7,25);
   Plot_comp__1->SetBinError(8,24);
   Plot_comp__1->SetBinError(9,22);
   Plot_comp__1->SetBinError(10,16);
   Plot_comp__1->SetBinError(11,13);
   Plot_comp__1->SetBinError(12,11);
   Plot_comp__1->SetBinError(13,15);
   Plot_comp__1->SetBinError(14,16);
   Plot_comp__1->SetBinError(15,17);
   Plot_comp__1->SetBinError(16,24);
   Plot_comp__1->SetBinError(17,31);
   Plot_comp__1->SetBinError(18,27);
...
// ------------>Primitives in pad: bottompad
   ...
   Graph2->SetMinimum(0.642951);
   Graph2->SetMaximum(1.357049);
