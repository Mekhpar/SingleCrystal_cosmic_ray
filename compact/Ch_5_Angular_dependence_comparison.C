...
//=========  (Wed Mar 20 14:32:32 2024) by ROOT version 6.26/08
...
// ------------>Primitives in pad: toppad
   ...
   entry->SetTextSize(0.04);
   leg->Draw();
   TLatex *   tex = new TLatex(0.17,0.83,"Ch 5");
tex->SetNDC();
   tex->SetTextFont(52);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   Plot_comp__1->SetBinContent(4,23);
   Plot_comp__1->SetBinContent(5,18);
   Plot_comp__1->SetBinContent(6,17);
   Plot_comp__1->SetBinContent(7,12);
   Plot_comp__1->SetBinContent(8,12);
   Plot_comp__1->SetBinContent(9,15);
   Plot_comp__1->SetBinContent(10,14);
   Plot_comp__1->SetBinContent(11,12);
   Plot_comp__1->SetBinContent(12,13);
   Plot_comp__1->SetBinContent(13,20);
   Plot_comp__1->SetBinContent(14,25);
   Plot_comp__1->SetBinContent(15,32);
   Plot_comp__1->SetBinContent(16,40);
   Plot_comp__1->SetBinContent(17,48);
   Plot_comp__1->SetBinContent(18,46);
   Plot_comp__1->SetBinContent(19,28);
   Plot_comp__1->SetBinError(1,28);
   Plot_comp__1->SetBinError(2,29);
   Plot_comp__1->SetBinError(3,31);
   Plot_comp__1->SetBinError(4,23);
   Plot_comp__1->SetBinError(5,18);
   Plot_comp__1->SetBinError(6,17);
   Plot_comp__1->SetBinError(7,12);
   Plot_comp__1->SetBinError(8,12);
   Plot_comp__1->SetBinError(9,15);
   Plot_comp__1->SetBinError(10,14);
   Plot_comp__1->SetBinError(11,12);
   Plot_comp__1->SetBinError(12,13);
   Plot_comp__1->SetBinError(13,20);
   Plot_comp__1->SetBinError(14,25);
   Plot_comp__1->SetBinError(15,32);
   Plot_comp__1->SetBinError(16,40);
   Plot_comp__1->SetBinError(17,48);
   Plot_comp__1->SetBinError(18,46);
...
// ------------>Primitives in pad: bottompad
   ...
   Graph2->SetMinimum(0.6537038);
   Graph2->SetMaximum(1.346296);
